...
DECLARE_COMMANDID(MotionLineBeginSelect)
DECLARE_COMMANDID(MotionLineEnd)
DECLARE_COMMANDID(MotionLineEndSelect)

DECLARE_COMMANDID(MotionLineFirstChar)

DECLARE_COMMANDID(MotionGotoBeginning)
DECLARE_COMMANDID(MotionGotoBeginningSelect)
DECLARE_COMMANDID(MotionGotoEnd)
DECLARE_COMMANDID(MotionGotoEndSelect)
